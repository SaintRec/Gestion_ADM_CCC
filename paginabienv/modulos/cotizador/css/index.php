...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="/bootstrap-3.3.5/css/will.css">
	<link rel="stylesheet" href="/bootstrap-3.3.5/css/will.min.css">
	<link rel="stylesheet" href="/bootstrap-3.3.5/css/will.theme.min.css">
  ...
  <body>
    <div class="container">
		  <div class="row-fluid">
			<div class="col-md-12">
			<h2><span class="glyphicon glyphicon-edit1"></span> Nueva Cotización</h2>
			<hr>
			  ...
			  <div class="modal-dialog modal-lg" role="document">
				<div class="modal-content1">
				  <div class="modal-header1">
					...
					<h4 class="modal-title1" id="myModalLabel">Buscar productos</h4>
				  </div>
				  <div class="modal-body1">
					<form class="form-horizontal">
					  <div class="form-group">
						...
						<button type="button" class="btn btn-default" onclick="load(1)"><span class='glyphicon glyphicon-search1'></span> Buscar</button>
					  </div>
					</form>
